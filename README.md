...
> 当前版本：`0.8.0` · 最近整理：2026-08-29

- **文档站上线**：新增中文优先的 VitePress 文档站，集中整理部署、配置、Widget、备份和常见问题。
- **F1 组件增强**：支持在赛程与最新车手积分之间切换，积分由服务端缓存并在上游不可用时回退。
- **Demo 更新**：默认演示首页加入 F1 赛程、车手积分和 Komari 节点，展示当前核心组件组合。
- **部署文档收口**：围绕个人局域网部署补充完整 `.env` 示例、访问密码、天气、Komari 和 Demo 配置说明。

完整变更记录见[更新记录](./changelog.md)。
