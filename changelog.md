...
### docs: 将文档站调整为使用与配置指南
- 做了什么：缩小文档站正文、标题和移动端字号，将首页从产品介绍改为首次使用与常用任务入口；新增访问密码、天气、Komari、F1 数据与 Demo 模式的集中配置页，并细化书签、布局和各 Widget 的实际操作步骤
- 影响范围：文档站信息层级、排版密度、用户部署后的配置与使用路径
- 涉及模块：`docs-site/index.md`、`docs-site/guide/`、VitePress 导航与主题样式、`README*.md`
