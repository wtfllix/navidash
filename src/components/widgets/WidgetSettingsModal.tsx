...
export default function WidgetSettingsModal({ widget, isOpen, onClose }: WidgetSettingsModalProps) {
  ...
  const renderConfigFields = () => {
    switch (widget.type) {
          ...
          <>
            <div>
             ...
             <p className="text-xs text-gray-500 mt-2">
               Find coordinates at <a href="https://open-meteo.com/" target="_blank" className="text-blue-500 underline">open-meteo.com</a>
             </p>
          </>
        );
      case 'quick-link':
      ...
      default:
        return <p className="text-sm text-gray-500">No configuration available for this widget.</p>;
    }
  };
        ...
        <div>
          ...
          <div className="flex items-center space-x-4">
             <div className="flex-1">
                <label className="text-xs text-gray-500 block mb-1">Width (Columns)</label>
                <select 
                  value={size.w}
             ...
             <div className="flex-1">
                <label className="text-xs text-gray-500 block mb-1">Height (Rows)</label>
                <select 
                  value={size.h}
